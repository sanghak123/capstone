'''
Build recommendations based on trained SVM model
    ...
    with open(output_file, 'w') as fp:
        ...
        for i in item_ids:
            ...
            if len(data) > 0:
                ...
                dtest = pd.DataFrame(data, columns=['title_match', 'clevel_match', 'indus_match', 'discipline_match', 'country_match', 'region_match'])
